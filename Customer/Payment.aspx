<%@ Page Language="C#" MasterPageFile="~/MasterPage/PopUp.Master" AutoEventWireup="true"
    CodeBehind="Payment.aspx.cs" Inherits="Man.Customer.Payment" Title="Danh Sách Hợp Đồng" %>
            ...
            <div class="edit_form">
                ...
                <table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="input_form" colspan="3">
                            <asp:TextBox ID="txtComment" TextMode="MultiLine" Rows="2" runat="server" MaxLength="100" Width="95%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
