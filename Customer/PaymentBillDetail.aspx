                    ...
                    <div class="box_contentmain">
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="Label3" Text="Thông Tin Hóa Đơn" runat="server"></asp:Label>
                                    </a></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="bgmid_main">
                            ...
                            <div class="content_form">
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" class="tablelist01">
                                    <tr>
                                        ...
                                        <td class="input_form" colspan="3">
                                            <asp:Label ID="lblName" runat="server" MaxLength="100" Width="98%"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <asp:TextBox ID="txtBillNo" runat="server" MaxLength="100" Width="98%"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td valign="top" class="text_label">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtBillDate" runat="server" MaxLength="100" Width="98%"></asp:TextBox>
                                        ...
                                        <td width="15%" valign="top" class="text_label">
                                            Áp dụng lúc <font color="red">※</font>
                                        </td>
                                        <td class="input_form">
                                            <asp:TextBox ID="txtUsdExchangeDate" runat="server" MaxLength="100" Width="98%"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td class="text_label" style="vertical-align: middle">
                                            Chọn tháng
                                        </td>
                                        <td align="left" class="input_form" colspan="2">
                                            <asp:ListBox ID="lstYearMonth" runat="server" SelectionMode="Multiple" Width="98%"
                                                Height="120px"></asp:ListBox>
                                        </td>
                                        <td style="vertical-align: middle" align="center">
                                            <asp:Button CssClass="btn_blue_short" ID="btnSelect" runat="server" Text=">" OnClick="btnSelect_Click" /><br />
                                            <br />
                                            <asp:Button CssClass="btn_blue_short" ID="btnUnSelect" runat="server" Text="<" OnClick="btnUnSelect_Click" /><br />
                                        </td>
                                        <td align="left" class="input_form" colspan="2">
                                            <asp:ListBox ID="lstSelectedYearMonth" runat="server" SelectionMode="Multiple" Width="98%"
                                                Height="120px"></asp:ListBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6" align="center">
                                            <asp:Button CssClass="btn_blue" ID="btnCreate" runat="server" Text="Lưu Hóa Đơn"
                                                OnClick="btnSave_Click" Style="white-space: nowrap;" />
                                            <asp:Button CssClass="btn_blue" ID="btnlReCal" runat="server" Text="Kết Sổ" OnClick="btnReCal_Click"
                                                Style="white-space: nowrap;" />
                                            <asp:Button CssClass="btn_blue" ID="Button7" runat="server" Text="Xuất" OnClick="btnViewMulti_Click"
                                                Style="white-space: nowrap;" />
                                            <asp:Button CssClass="btn_blue" ID="Button3" runat="server" Text="Xuất(New)" OnClick="btnNewView_Click"
                                                Style="white-space: nowrap;" />
                                                <asp:Button CssClass="btn_blue" ID="Button4" runat="server" Text="Xuất(New Full)" OnClick="btnFullNewView_Click"
                                                Style="white-space: nowrap;" />
                                            
                                                <br />
                                            
                                                Lưu hóa đơn: lưu thông tin hóa đơn với thông tin ngày, tỉ giá, hóa đơn tháng
                                                <br />
                                                Kết sổ:thực hiện tính giá trị Phí phải trả cho tháng đã chọn
                                                <br />
                                                Xuất: tạo hóa đơn (file Excel) với giá trị Phí đã thực hiện tính toán
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            <div class="title_form">
                                                Thông Tin Thu Tiền</div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="6" align="center">
                                            <asp:Button CssClass="btn_blue" ID="Button1" runat="server" Text="Thu Tiền Tháng"
                                                OnClick="btnPaymentMonth_Click" Style="white-space: nowrap;" />
                                            <asp:Button CssClass="btn_blue" ID="Button2" runat="server" Text="Thu Trước" OnClick="btnPrePaid_Click"
                                                Style="white-space: nowrap;" />
                                        </td>
                                    </tr>
                                </table>
