<%@ Page Language="C#" MasterPageFile="~/MasterPage/PopUp.Master" AutoEventWireup="true"
    CodeBehind="CustomerComplain.aspx.cs" Inherits="Man.Customer.CustomerComplain"
    Title="Thông Tin Phàn Nàn" %>
        ...
        <ContentTemplate>
            <div class="edit_form">
                <div class="title_form">
                    <asp:Label runat="server" ID="lblHeader" Text="Thông Tin Ý Kiến Của Khách Hàng"></asp:Label>
                </div>
                <table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                        <td width="25%" valign="top" class="text_label">
                            Kết quả giải quyết
                        </td>
                        <td class="input_form">
                            <asp:TextBox ID="txtSolution" runat="server" MaxLength="200" Rows="3" TextMode="MultiLine"
                                Width="95%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound"
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Literal ID="ltrSolution" runat="server"></asp:Literal>
                                </td>
                                <td align="left">
