...
{
    public partial class ComplainCustomer : Man.PageBase
    {
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                sql += " WHERE (ID IS NOT NULL) and DelFlag <> 1 and Type = '2' and BuildingId = '" + Func.ParseString(Session["__BUILDINGID__"]) + "' and CustomerId = '" + hidId.Value + "'";
