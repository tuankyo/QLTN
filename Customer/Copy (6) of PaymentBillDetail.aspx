                                ...
                                <table cellpadding="1" cellspacing="1" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: xx-small">
                                            <asp:TextBox ID="txtBillDate" runat="server" MaxLength="100" Width="95%"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td class="input_form">
                                            <asp:TextBox ID="txtUsdExchangeDate" runat="server" MaxLength="100" Width="95%"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <br />
                                            <asp:Button CssClass="btn_blue_short" ID="btnSelect" runat="server" Text=">" OnClick="btnSelect_Click" /><br /><br />
                                            <asp:Button CssClass="btn_blue_short" ID="btnUnSelect" runat="server" Text="<" OnClick="btnUnSelect_Click" /><br /><br />
                                            <asp:Button CssClass="btn_blue" ID="Button8" runat="server" Text="Kiểm tra Dữ Liệu"
                                                OnClick="btnSumMulti_Click" Style="white-space: nowrap;" /><br /> Thực hiện Kiểm tra dữ liệu nếu các tháng đã chọn chưa ra kết quả
                                        </td>
                                        <td align="left" class="input_form">
                                    ...
                                    <tr>
                                        <td colspan="4" align="center">
                                            <asp:Button CssClass="btn_blue" ID="ViewSum" runat="server" Text="Xem" OnClick="btnViewSum_Click"
                                                Style="white-space: nowrap;" />
                                    ...
                                    <tr>
                                        <td colspan="4" align="center">
                                            <asp:Button CssClass="btn_blue" ID="Button1" runat="server" Text="Thu Tiền Tháng" OnClick="btnPaymentMonth_Click"
                                                Style="white-space: nowrap;" />
