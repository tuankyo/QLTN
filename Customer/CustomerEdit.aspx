<%@ Page Language="C#" MasterPageFile="~/MasterPage/PopUp.Master" AutoEventWireup="true"
    CodeBehind="CustomerEdit.aspx.cs" Inherits="Man.Customer.CustomerEdit" Title="Thông Tin Khách Hàng" %>
            ...
            <div class="edit_form">
                ...
                <table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="input_form">
                            <asp:TextBox ID="txtEmail" runat="server" MaxLength="100" Width="95%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td width="25%" valign="top" class="text_label">
                            Người liên lạc<font color="red">※</font>
                        </td>
                        <td class="input_form">
                            <asp:TextBox ID="txtContactName" runat="server" MaxLength="100" Width="95%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td width="25%" valign="top" class="text_label">
                            Xuất Bill mỗi tháng tính theo<font color="red">※</font>
                        </td>
                        <td class="input_form">
                            <asp:RadioButton ID ="rdoMonthPaymentTypeFirst" runat="server" GroupName="MonthPaymentType" />Thu trước 
                            <asp:RadioButton ID ="rdoMonthPaymentTypeLast" runat="server" GroupName="MonthPaymentType" />Thu sau
                        </td>
                    </tr>
                    <tr>
                        <td class="text_label">
