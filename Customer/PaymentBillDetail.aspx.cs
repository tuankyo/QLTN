...
namespace Man.Customer
{
    public partial class PaymentBillDetail : PageBase
    {
        ...
        protected void btnNewView_Click(object sender, EventArgs e)
        {
            string lsYearmonth = "";
            foreach (ListItem lstItem in lstSelectedYearMonth.Items)
            {
            ...
            NewViewMultiBoth(lsYearmonth);
        }
        protected void btnFullNewView_Click(object sender, EventArgs e)
        {
            string lsYearmonth = "";
            foreach (ListItem lstItem in lstSelectedYearMonth.Items)
            {
            ...
            FullNewViewMultiBoth(lsYearmonth);
        }
        ...
        public void setValReplace(int row, int col, string strReplace,string val)
        {
            xlsSheet[row, col].Value = xlsSheet[row, col].Value.ToString().Replace(strReplace, val);
            xlsSheetEn[row, col].Value = xlsSheetEn[row, col].Value.ToString().Replace(strReplace, val);
        }
        ...
        public void NewViewMultiBoth(string lsYearmonth)
        {
            string[] strTmpYearMonth = lsYearmonth.Split(',');
            string maxYearMonth = "";
            for (int l = 0; l < strTmpYearMonth.Length; l++)
            ...
            using (SqlDatabase db = new SqlDatabase())
            {
                ...
                ///////////////
                setStyle(lineTmp + 3, 2, xlstStyleSum0);
