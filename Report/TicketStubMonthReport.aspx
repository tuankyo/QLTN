<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="TicketStubMonthReport.aspx.cs" Inherits="Man.Report.TicketStubMonthReport"
    Title="Báo Cáo" %>
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="ltrPage" runat="server">Báo cáo tổng hợp vé lượt</asp:Label>
                                    </a></li>
                                </ul>
                            </div>
                        </div>
