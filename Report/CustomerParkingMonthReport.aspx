<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="CustomerParkingMonthReport.aspx.cs" Inherits="Man.Report.CustomerParkingMonthReport"
    Title="Báo Cáo" %>
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="ltrPage" runat="server">Báo cáo xe tháng</asp:Label>
                                    </a></li>
                                </ul>
                            </div>
                        </div>
