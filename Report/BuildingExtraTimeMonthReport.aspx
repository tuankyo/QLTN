<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="BuildingExtraTimeMonthReport.aspx.cs" Inherits="Man.Report.BuildingExtraTimeMonthReport"
    Title="Báo Cáo" %>
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="ltrPage" runat="server">Báo cáo Nước tiêu thụ</asp:Label>
                                    </a></li>
                                </ul>
                            </div>
                        </div>
