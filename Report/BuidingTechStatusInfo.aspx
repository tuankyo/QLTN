<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="BuidingTechStatusInfo.aspx.cs" Inherits="Man.Report.BuidingTechStatusInfo"
    Title="Báo Cáo" %>
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="ltrPage" runat="server">TỔNG HỢP  SỰ CỐ KỸ THUẬT TÒA NHÀ</asp:Label>
                                    </a></li>
                                </ul>
                            </div>
                        </div>
