<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="BuildingMaintenancePlanReport.aspx.cs" Inherits="Man.Report.BuildingMaintenancePlanReport"
    Title="Báo Cáo" %>
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="ltrPage" runat="server">Báo cáo Kế Hoạch - Thực hiện bảo trì</asp:Label>
                                    </a></li>
                                </ul>
                            </div>
                        </div>
