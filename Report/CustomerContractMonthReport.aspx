<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="CustomerContractMonthReport.aspx.cs" Inherits="Man.Report.CustomerContractMonthReport"
    Title="Báo Cáo" %>
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="ltrPage" runat="server">Tổng Hợp Hợp Đồng</asp:Label>
                                    </a></li>
                                </ul>
                            </div>
                        </div>
