<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="BuidingConstructionReport.aspx.cs" Inherits="Man.Report.BuidingConstructionReport"
    Title="Báo Cáo" %>
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="ltrPage" runat="server">Báo cáo Nhật Ký Hằng Ngày</asp:Label>
                                    </a></li>
                                </ul>
                            </div>
                        </div>
