<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="BuidingMaintenanceReport.aspx.cs" Inherits="Man.Report.BuidingMaintenanceReport"
    Title="Báo Cáo" %>
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="ltrPage" runat="server">Báo cáo Kế Hoạch Bảo Trì</asp:Label>
                                    </a></li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                    <tr>
                                        ...
                                        <td class="input_form">
                                            ...
                                            <asp:Button CssClass="btn_blue" runat="server" ID="Button2" Text="Xuất Report" OnClick="btnExport_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
