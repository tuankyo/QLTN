...
{
    public partial class NewListRbtImport : PageBase
    {
        ...
        protected void btnRegister_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string insert = " INSERT INTO SongMedia (SongMediaId,SongId,Title,TypeId,IsrcNo,rate,Price,PRText,HaishinDate,HaishinEndDate,PriceNoTax,BuyUnique,CopyrightFeeUnique,KDDICommissionUnique,ProfitUnique,Flag,DelFlag,Updated , Updator, Created, Creator) " +
                                " Select SongMediaId,SongId,Title,'4',ISRCNo,rate,Price,PRText,HaishinDate,HaishinEndDate,PriceNoTax,BuyUnique,CopyrightFeeUnique,KDDICommissionUnique,ProfitUnique,'1', '0','" + updated + "','" + updator + "','" + created + "','" + creator + "' from  SongMediaRbtTmp where SessionId = '" + Session.SessionID + "' ";
