<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="RbtUpdateImport.aspx.cs" Inherits="Man.MasterImport.RbtUpdateImport"
    Title="" %>
                     ...
                     <tr>
                        <td class="MiddleLeft"></td>
                         <td class ="MiddleCenter">
                            ...
                            <table class="Tb100">
                            <tr>
                                <th colspan="4" style="background-color:#99CCFF">
                                <asp:Label runat="server" ID="lblHeader" Text="RBT情報一括更新"></asp:Label>
                                </td>                            
                            </tr>
                            <tr>
