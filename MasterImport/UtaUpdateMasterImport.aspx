<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="UtaUpdateMasterImport.aspx.cs" Inherits="Man.MasterImport.UtaUpdateMasterImport"
    Title="" %>
                     ...
                     <tr>
                        <td class="MiddleLeft"></td>
                         <td class ="MiddleCenter">
                            ...
                            <table class="Tb100">
                            <tr>
                                <th colspan="4" style="background-color:#AFDD23">
                                <asp:Label runat="server" ID="lblHeader" Text="着うた情報一括更新"></asp:Label>
                                </td>                            
                            </tr>
                            <tr>
