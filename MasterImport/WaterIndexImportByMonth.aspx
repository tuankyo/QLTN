<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="WaterIndexImportByMonth.aspx.cs" Inherits="Man.MasterImport.WaterIndexImportByMonth"
    Title="" %>
                        ...
                        <td class="MiddleLeft"></td>
                         <td class ="MiddleCenter">
                            ...
                            <tr>
                                ...
                                <td><font color="red">NAMTHANG,MACC,MACH,CSC,CSM</font></td>
                            </tr>
                            <tr>
                                <td class="Title">Giải thích</td>
                                <td><font color="red">NAMTHANG</font>:Năm Tháng (yyyyMM), <font color="red">MACC</font>:Mã Chung Cư, <font color="red">MACH</font>:Mã Căn Hộ, <font color="red">CSC</font>:Chỉ Số Củ, <font color="red">CSM</font>:Chỉ Số Mới</td>
                            </tr>            
                            <tr>
