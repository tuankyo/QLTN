<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="NewListMasterImport.aspx.cs" Inherits="Man.ImportMaster.NewListMasterImport"
    Title="一括登録曲一覧" %>
                             ...
                             <asp:Repeater id="rptList" runat="server"
                                   ...
                                   <HeaderTemplate>
                                        <tr class="GridHeader" id="line" runat="server">
                                            ...
                                            <th class="GridHeader">
                                                <asp:LinkButton CommandName="SortSongDcSearchTitle" ID="lnkSongDcSearchTitle" runat="server" Text="DC登録検索曲名" />
                                            </th>
                                            ...
                                            <th class="GridHeader"><asp:LinkButton CommandName="SortCopyrightContractId" id="lnkCopyrightContractId" runat="server" Text="著作権管理団体" /></th>
                                    ...
                                    <ItemTemplate>
                                           <tr <asp:Literal ID="ltrBg" runat="server"></asp:Literal>>
                                               ...
                                               <td align="left">
                                                   <asp:Literal ID="ltrSongDcSearchTitle" runat="server"></asp:Literal>
                                               </td>
                                                ...
                                                <td align="left"><asp:Literal ID="ltrCopyrightContractId" runat="server"></asp:Literal></td>
                       ...
                       <table>
                            ...
                            <!--
                             ...
                             -->   
                                ...
                                <td>
                                    <asp:Button ID="btnGetExistsID" runat="server" Text="既存うた/ビデオ出力" OnClick="btnGetExistsID_Click"
                                        Width="150px" />
                                </td>
                            </tr>
                       </table>
