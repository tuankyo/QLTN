<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="NewListChakuKaraFullImport.aspx.cs" Inherits="Man.ImportMaster.NewListChakuKaraFullImport"
    Title="ˆêŠ‡“o˜^‹Èˆê——" %>
             ...
             <table class="TbNoHeader" cellpadding="0" cellspacing="0">
                <tr>
                 ...
                 <tr>
                    ...
                    <asp:Label runat="server" ID="lblHeader" Text="’…ƒJƒ‰ƒtƒ‹î•ñˆêŠ‡“o˜^ˆê——"></asp:Label>
                    </td>                            
                </tr>
                 <tr>
                    <td class="MiddleLeft">
                             ...
                             <asp:Repeater id="rptList" runat="server"
                                   ...
                                   <HeaderTemplate>
                                        <tr class="GridHeader" id="line" runat="server">
                                            ...
                                            <th class="GridHeader"><asp:LinkButton CommandName="SortTitle" id="lnkTitle" runat="server" Text="‹È–¼" /></th>
                                            <th class="GridHeader"><asp:LinkButton CommandName="SortArtistId" id="lnkArtistId" runat="server" Text="ƒA[ƒeƒBƒXƒgID" /></th>
                                            <th class="GridHeader"><asp:LinkButton CommandName="SortGenreId" id="lnkGenreId" runat="server" Text="ƒWƒƒƒ“ƒ‹ID" /></th>
                                            <th class="GridHeader"><asp:LinkButton CommandName="SortAlbumId" id="lnkAlbumId" runat="server" Text="ƒAƒ‹ƒoƒ€ID" /></th>
                                            <th class="GridHeader"><asp:LinkButton CommandName="SortLabelId" id="lnkLabelId" runat="server" Text="ƒŒ[ƒxƒ‹ID" /></th>
                                            <th class="GridHeader"><asp:LinkButton CommandName="SortContractorId" id="lnkContractorId" runat="server" Text="Œ_–ñŽÒ" /></th>
                                            <th class="GridHeader"><asp:LinkButton CommandName="SortCopyrightOrg" id="lnkCopyrightOrg" runat="server" Text="’˜ìŒ ŠÇ—’c‘Ì" /></th>
                                            <th class="GridHeader"><asp:LinkButton CommandName="SortJasracWorksCode" id="lnkJasracWorksCode" runat="server" Text="JASRACì•iƒR[ƒh" /></th>
