...
namespace Man.User
{
    public partial class AdminListUser : PageBase
    {
        ...
        protected override void DoPost()
        {
            ...
            {
                if (eventTarget == "PopUpAdminEditUser")
                {
                    ShowData();
                }
            }
        ...
        protected void ShowData()
        {
            ...
            try
            {
                ...
                sql = "SELECT count(distinct U.UserName)"
                 ...
                 + " WHERE M.UserId=U.UserId " + GetWhere();
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if ((item.ItemType == ListItemType.Item) || (item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                btnEdit.OnClientClick = "PopUp('AdminEditUser.aspx?Action=Edit&UserName=" + userName + "', 600,500,'AdminEditUser', true); return false;";
            ...
            else if (item.ItemType == ListItemType.Header)
            {
                ...
                btnAdd.OnClientClick = "PopUp('AdminEditUser.aspx', 600,500,'EditUser', true); return false;";
