...
{
    public partial class UsedWaterRoomEdit : Man.PageBase
    {
        ...
        private string postback = "window.opener.__doPostBack('PopupUsedWaterRoomEdit','');";
        private string key = "openUsedWaterRoomEdit";
