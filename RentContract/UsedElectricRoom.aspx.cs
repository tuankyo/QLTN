...
{
    public partial class UsedElectricRoom : PageBase
    {
        ...
        private string popup = "PopupUsedElectricRoomEdit";
        private string editPageName = "UsedElectricRoomEdit";
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                sql += " FROM BD_Room AS A INNER JOIN UsedElectricRoom AS B ON A.id = B.RoomId";
                ...
                //FROM         dbo.BD_Room AS A INNER JOIN dbo.UsedElectricRoom AS B ON A.id = B.RoomId
