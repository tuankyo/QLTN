<%@ Page Language="C#" MasterPageFile="~/MasterPage/PopUp.Master" AutoEventWireup="true"
    CodeBehind="RC_Room.aspx.cs" Inherits="Man.RentContract.RC_Room" Title="Thông Tin HĐ Thuê Phòng" %>
        ...
        <ContentTemplate>
            <div class="content_form">
                ...
                <table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                        <td width="14%" valign="top" class="text_label">
                            Trọn gói<font color="red">※</font>
                        </td>
                        <td class="input_form" colspan="3">
                            <asp:CheckBox ID="chkRentType" runat="server" AutoPostBack="true" OnCheckedChanged="chkRentTypeChange" /><font
                                color="red">※Check:Phí Thuê được xuất Bill cho tháng kết thúc thuê.Uncheck:Phí
                                thuê được tính theo tháng</font>
                        </td>
                    </tr>
                    <tr>
                        <td width="14%" valign="top" class="text_label">
                    ...
                    <tr>
                        <td valign="top" class="text_label">
                            Tính phí theo<font color="red">※</font>
                        </td>
                        <td class="input_form">
                            <asp:RadioButton ID="rdoExtraTimeM" runat="server" Checked="true" GroupName="extratime" Text="m2" AutoPostBack="true" OnCheckedChanged="rdoCheckedChanged" />
                            <asp:RadioButton ID="rdoExtraTimeA" runat="server" GroupName="extratime" Text="diện tích"  AutoPostBack="true" OnCheckedChanged="rdoCheckedChanged"/>
                        </td>
                        <td valign="top" class="text_label">
                            Giá thấp nhất<font color="red">※</font>
                        </td>
                        <td class="input_form">
                            <asp:TextBox ID="txtMinPriceVND" runat="server" MaxLength="100" Width="30%" />VND
                            <asp:TextBox ID="txtMinPriceUSD" runat="server" MaxLength="100" Width="30%" />USD
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="input_form">
                            <asp:TextBox ID="txtMonthExtraTimePriceVND" Enabled="false" runat="server" MaxLength="100" Width="30%" />VND
                            <asp:TextBox ID="txtMonthExtraTimePriceUSD" Enabled="false" runat="server" MaxLength="100" Width="30%" />USD
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                    ...
                    <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound"
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="right">
                                    <asp:Literal ID="ltrBeginContractDate" runat="server" />
                                </td>
                                <td align="right">
                                    <asp:Literal ID="ltrEndContractDate" runat="server" />
                                </td>
                                <td align="left">
                                    <asp:Literal ID="ltrComment" runat="server" />
                                </td>
                                <td align="left">
                                    <asp:Button CssClass="btn_blue" ID="btnUpdate" CommandName="Update" runat="server"
                                        Text="Cập nhật" />
                                </td>
                                <td align="left">
                                    <asp:Button CssClass="btn_blue_short" OnClientClick="javascript:return confirm('Thông tin sẽ được cập nhật?')"
                                        ID="btnDelete" CommandName="Delete" runat="server" Text="Xóa" />
                                </td>
                                <td align="center">
