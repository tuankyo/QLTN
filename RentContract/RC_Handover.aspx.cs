...
{
    public partial class RC_Handover : Man.PageBase
    {
        ...
        protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            else if (command.Equals("HandoverPaid"))
            {
                Response.Redirect("RC_HandoverPaid.aspx?rcid=" + lblId.Text + "&id=" + Func.ParseString(e.CommandArgument));
            }
            else if (command.Equals("Delete"))
            {
                DbHelper.ExecuteDB("Update RC_Handover Set DelFlag = 1 Where ID = '" + Func.ParseString(e.CommandArgument) + "'");
                ShowData();
            }
        }
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            try
            {
                if ((item.ItemType == ListItemType.Item) || (item.ItemType == ListItemType.AlternatingItem))
                {
                    ...
                    string RoomId = Func.ParseString(row["ID"]);
                    ...
                    string Handover = Func.ParseString(row["Handover"]);
                    ...
                    Func.SetGridTextValue(item, "ltrHandover", Handover);
                    ...
                    Button btnReturn = (Button)item.FindControl("btnReturn");
                    btnReturn.CommandArgument = Func.ParseString(row["id"]);
                }
