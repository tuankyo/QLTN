<%@ Page Language="C#" MasterPageFile="~/MasterPage/PopUp.Master" AutoEventWireup="true"
    CodeBehind="BD_WorkingPlaceEdit.aspx.cs" Inherits="Man.Building.WorkingPlace.BD_WorkingPlaceEdit"
    Title="Thông Tin Khu Vực Làm Việc" %>
        ...
        <ContentTemplate>
            <div class="edit_form">
                <div class="title_form">
                    <asp:Label runat="server" ID="lblHeader" Text="Thông Tin Khu Vực Làm Việc"></asp:Label>
                </div>
                <table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                        <td width="25%" valign="top" class="text_label">
                            Mã vị trí làm việc<font color="red">※</font>
                        </td>
                        <td class="input_form">
