<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="BD_WorkingPlaceList.aspx.cs" Inherits="Man.Building.WorkingPlace.BD_WorkingPlaceList"
    Title="Khu vực làm việc" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainPhd" runat="server">
    <asp:UpdatePanel ID="upBD_WorkingPlace" runat="server">
        <ContentTemplate>
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="ltrPage" Text="Thông tin tòa nhà &gt Khu vực làm việc" runat="server"></asp:Label>
                                    </a></li>
                                </ul>
                            </div>
                        </div>
