...
{
    public partial class BD_MeetingRoomList : PageBase
    {
        ...
        private string editPageName = "BD_MeetingRoomBooking";
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                sql += " Select COUNT(ID) ";
                sql += " FROM BD_Room";
                sql += " WHERE (ID IS NOT NULL) and DelFlag <> 1 and BuildingId = '" + Func.ParseString(Session["__BUILDINGID__"]) + "' and IsMeetingRoom = '1'";
        ...
        protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect(editPageName + ".aspx?id=" + Func.ParseString(e.CommandArgument));
            }
