...
{
    public partial class BD_RoomElecIndex : Man.PageBase
    {
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                sql += " WHERE (ID IS NOT NULL) and DelFlag <> 1 and RoomId = '" + lblRoomId.Text + "' and TarrifsType = 1";
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            try
            {
                if ((item.ItemType == ListItemType.Item) || (item.ItemType == ListItemType.AlternatingItem))
                {
                    ...
                    Func.SetGridTextValue(item, "ltrOldIndex", OldIndex);
                    Func.SetGridTextValue(item, "ltrNewIndex", NewIndex);
