                            ...
                            <div class="content_form">
                                <table cellpadding="1" cellspacing="1" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="input_form">
                                            <asp:DropDownList ID="drpMeetingRoom" runat="server" AutoPostBack="true" OnSelectedIndexChanged="drpMeetingRoom_OnSelectedIndexChanged">
                                            </asp:DropDownList>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="11" class="input_form">
                                            <asp:Label ID="lblHourRentPriceVND" runat="server"></asp:Label>VND
                                            <asp:Label ID="lblHourRentPriceUSD" runat="server"></asp:Label>USD
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text_label">
                                    ...
                                    <tr>
                                        <td colspan="12">
                                            <div class="title_form">
                                                Thời gian Phòng họp Đang Trống hoặc Đã được đặt
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" colspan="9">
                                            <asp:Button CssClass="btn_blue" ID="btnAdd" runat="server" Text="Đặt phòng" OnClick="btnAdd_Click"
