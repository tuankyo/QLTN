                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="input_form">
                                            <asp:LinkButton ID="lnbCustomerId" runat="server" Width="95%" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text_label">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="5" class="input_form">
                                            ...
                                            (VND) &nbsp;&nbsp;&nbsp;
                                            <asp:TextBox ID="txtPriceUSD" runat="server" Width="20%"></asp:TextBox>
                                            USD
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td colspan="5" class="input_form">
                                            <asp:TextBox ID="txtVat" runat="server" Width="20%" Style="text-align: right"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text_label">
                                    ...
                                    <tr>
                                        ...
                                        <td class="input_form" align="right">
                                            <asp:TextBox ID="txtPaidUSD" runat="server" Width="95%" Style="text-align: right" />
                                        </td>
                                        <td class="input_form">
                                            (USD)
                                        </td>
                                        <td class="input_form" align="right">
                                            <asp:TextBox ID="txtPaidVND" runat="server" Width="95%" Style="text-align: right" />
                                        </td>
                                        <td colspan="2" class="input_form">
                                            (VND)
                                        </td>
                                    ...
                                    <div id="divPaid" runat="server">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtContractDate" runat="server" Width="95%" />
                                        ...
                                        <tr>
                                            ...
                                            <td class="input_form" align="left">
                                                <asp:TextBox ID="txtRate" runat="server" Width="95%" />
                                            </td>
                                            <td class="text_label">
                                                Thời gian quy đổi
                                            </td>
                                            <td colspan="3" align="left">
                                                <asp:TextBox ID="txtRateDate" runat="server" Width="95%" />
                                        ...
                                        <tr>
                                            ...
                                            <td class="input_form" align="left">
                                                <asp:TextBox ID="txtPaymenter" runat="server" Width="95%" Style="text-align: right" />
                                            </td>
                                            <td class="text_label">
                                                Người nhận
                                            </td>
                                            <td colspan="3" align="left">
                                                <asp:TextBox ID="txtReceiver" runat="server" Width="95%" Style="text-align: right" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text_label">
                                            ...
                                            <td colspan="3" align="left">
                                                <asp:TextBox ID="txtMoney" runat="server" Width="95%" Style="text-align: right" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="text_label">
