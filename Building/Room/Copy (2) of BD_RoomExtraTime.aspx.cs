    ...
    public partial class BD_RoomExtraTime : Man.PageBase
    {
        ...
        private void InsertData()
        {
            ...
            if (!HasError)
            {
                ...
                data.FromWD = Func.FormatYYYYmmdd(txtFromWD.Text.Trim());
                ...
                data.PriceVND = dataR.MonthExtraTimePriceVND;
        ...
        protected override void DoInit()
        {
            ...
            txtFromWD.Text = DateTime.Now.ToString("dd/MM/yyyy");
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            try
            {
                if ((item.ItemType == ListItemType.Item) || (item.ItemType == ListItemType.AlternatingItem))
                {
                    ...
                    Func.SetGridTextValue(item, "ltrWorkingDate", Func.FormatDMY(FromWD) + "~" + Func.FormatDMY(EndWD));
