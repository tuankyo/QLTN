<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="AdminBuildingList.aspx.cs" Inherits="Man.Building.AdminBuildingList" Title="Danh Sách Tòa Nhà Cho Thuê" %>
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="ltrPage" Text="Thông tin tòa nhà &gt Danh sách" runat="server" /></a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- mid content main -->
