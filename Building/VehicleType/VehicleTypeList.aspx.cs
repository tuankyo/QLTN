...
{
    public partial class VehicleTypeList : PageBase
    {
        ...
        private string popup = "PopupVehicleTypeEdit";
        private string editPageName = "VehicleTypeEdit";
