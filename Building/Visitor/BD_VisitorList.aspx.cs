...
{
    public partial class BD_VisitorList : PageBase
    {
        ...
        private string popup = "PopupBD_VisitorEdit";
        private string editPageName = "BD_VisitorEdit";
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            try
            {
                ...
                {                       
                    ...
                    string VisitDate = Func.FormatDMY(row["VisitDate"]);
                    ...
                    Func.SetGridTextValue(item, "ltrVisitDate", VisitDate);
