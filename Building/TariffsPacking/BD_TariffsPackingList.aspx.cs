...
{
    public partial class BD_TariffsPackingList : PageBase
    {
        ...
        private string popup = "PopupTariffsOfPackingEdit";
        private string editPageName = "BD_TariffsPackingEdit";
