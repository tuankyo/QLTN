<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="BD_TariffsPackingList.aspx.cs" Inherits="Man.Building.TariffsPacking.BD_TariffsPackingList"
    Title="Biểu phí gửi xe tháng" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainPhd" runat="server">
    <asp:UpdatePanel ID="upBD_TariffsOfPacking" runat="server">
        <ContentTemplate>
                            ...
                            <div class="tabs_menu">
                                <ul>
                                    <li class="current"><a href="">
                                        <asp:Label ID="ltrPage" Text="Kế toán &gt Biểu phí &gt Gửi xe tháng" runat="server"></asp:Label>
                                    </a></li>
                                </ul>
                            </div>
                        </div>
