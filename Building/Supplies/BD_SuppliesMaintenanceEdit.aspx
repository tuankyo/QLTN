<%@ Page Language="C#" MasterPageFile="~/MasterPage/PopUp.Master" AutoEventWireup="true"
    CodeBehind="BD_SuppliesMaintenanceEdit.aspx.cs" Inherits="Man.Building.Supplies.BD_SuppliesMaintenanceEdit"
            ...
            <div class="edit_form">
                ...
                <table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                        ...
                        <td class="input_form">
                            <asp:TextBox ID="txtExecDate" runat="server" MaxLength="100" Width="95%"></asp:TextBox>
