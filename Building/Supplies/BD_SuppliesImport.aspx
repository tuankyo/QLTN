<%@ Page Language="C#" MasterPageFile="~/MasterPage/PopUp.Master" AutoEventWireup="true"
    CodeBehind="BD_SuppliesImport.aspx.cs" Inherits="Man.Building.Supplies.BD_SuppliesImport"
    ...
    <asp:UpdatePanel ID="UpdatePopUp" runat="server">
        <ContentTemplate>
            <div class="edit_form">
                ...
                <div class="title_form">
                    <asp:Label runat="server" ID="Label1" Text="Thông Tin Nhập Kho"></asp:Label>
                </div>
                <table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                        <td width="25%" valign="top" class="text_label">
                            Ngày nhập kho<font color="red">※</font>
                        </td>
                        <td class="input_form">
                    ...
                    <tr>
                        <td width="25%" valign="top" class="text_label">
                            Người giao<font color="red">※</font>
                        </td>
                        <td class="input_form">
                            <asp:TextBox ID="txtImporter" runat="server" Width="95%" />
                        </td>
                    </tr>
                    <tr>
                        <td width="25%" valign="top" class="text_label">
                    ...
                    <tr>
                        <td width="25%" valign="top" class="text_label">
                            Từ nhà cung cấp<font color="red">※</font>
                        </td>
                        <td class="input_form">
                            <asp:TextBox ID="txtProviderFrom" runat="server" MaxLength="100" Width="95%"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td width="25%" valign="top" class="text_label">
                    ...
                    <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound"
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td align="left">
                                    <asp:Literal ID="ltrProvideFrom" runat="server"></asp:Literal>
                                </td>
                                <td align="left">
