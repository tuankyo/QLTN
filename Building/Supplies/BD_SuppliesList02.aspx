<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="BD_SuppliesList02.aspx.cs" Inherits="Man.Building.Supplies.BD_SuppliesList02"
                                    ...
                                    <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound"
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td align="center">
                                                    <asp:Button CssClass="btn_blue" ID="btnImport" Text="Nhập kho" runat="server" />
                                                </td>
                                                <td align="center">
                                                    <asp:Button CssClass="btn_blue" ID="btnExport" Text="Xuất kho" runat="server" />
                                                </td>
                                                <td align="right">
