...
{
    public partial class BD_SuppliesList03 : PageBase
    {
        ...
        protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("BD_SuppliesMaintenance.aspx?SuppliesType="+ hidSuppliesType.Value +"&id=" + Func.ParseString(e.CommandArgument));
            }
        }
