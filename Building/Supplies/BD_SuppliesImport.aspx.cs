...
{
    public partial class BD_SuppliesImport : Man.PageBase
    {
        ...
        {
            mvMessage.CheckRequired(txtProcessDate, "Ngày nhập kho: Danh mục bắt bắt buộc nhập");
            mvMessage.CheckRequired(txtImporter, "Người thực hiện: Danh mục bắt bắt buộc nhập");
            ...
            mvMessage.CheckRequired(txtPrice, "Đơn giá: Danh mục bắt bắt buộc nhập");
            mvMessage.CheckRequired(txtProviderFrom, "Nhà cung cấp: Danh mục bắt bắt buộc nhập");
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            try
            {
                if ((item.ItemType == ListItemType.Item) || (item.ItemType == ListItemType.AlternatingItem))
                {
                    ...
                    string Importer = Func.ParseString(row["Importer"]);
                    ...
                    string ProvideFrom = Func.ParseString(row["ProvideFrom"]);
                    ...
                    Func.SetGridTextValue(item, "ltrImporter", Importer);
                    ...
                    Func.SetGridTextValue(item, "ltrProvideFrom", ProvideFrom);
