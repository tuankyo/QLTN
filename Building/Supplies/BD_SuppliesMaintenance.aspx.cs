...
namespace Man.Building.Supplies
{
    public partial class BD_SuppliesMaintenance : PageBase
    {
        ...
        private string editPageName = "BD_SuppliesMaintenanceEdit";
        ...
        private void ShowData()
        {
            ...
            try
            {
                //Đếm số lượng record
                sql += " Select COUNT(ID) ";
                sql += " FROM BD_SuppliesMaintenanceItem";
                sql += " WHERE (Id IS NOT NULL) and DelFlag = 0 and SuppliesId = '" + hidId.Value + "'";
                sql += GetWhere();
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            try
            {
                if ((item.ItemType == ListItemType.Item) || (item.ItemType == ListItemType.AlternatingItem))
                {
                    ...
                    Func.SetGridTextValue(item, "ltrScheduleDate", ScheduleDate);
