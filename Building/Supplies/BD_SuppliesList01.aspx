<%@ Page Language="C#" MasterPageFile="~/MasterPage/Main.Master" AutoEventWireup="true"
    CodeBehind="BD_SuppliesList01.aspx.cs" Inherits="Man.Building.Supplies.BD_SuppliesList01"
                        ...
                        <div class="bgmid_main">
                            ...
                            <div class="content_form">
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" class="tablelist" border="1"
                                    ...
                                    <tr>
                                        <td align="center">
                                            <asp:DropDownList ID="drpGroupName" runat="server" Width="150px">
                                            </asp:DropDownList>
                                        </td>
                                        <td align="center">
                                    ...
                                    <asp:Repeater ID="rptList" runat="server" OnItemDataBound="rptList_ItemDataBound"
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                <td align="center">
                                                    <asp:Literal ID="ltrGroupName" runat="server" />
                                                </td>
                                                <td align="center">
                                                ...
                                                <td align="center">
                                                    <asp:Button CssClass="btn_blue" ID="btnStatus" Text="Tình Trạng" runat="server" />
                                                </td>
                                                <td align="left">
