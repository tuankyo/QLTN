...
{
    public partial class BD_StaffEvalInfoEdit : Man.PageBase
    {
        ...
        private void ShowData()
        {
            ...
            try
            {
                //Đếm số lượng record
                sql += " SELECT COUNT(ID) ";
                sql += " FROM [BD_StaffEvalInfo]";
                sql += " WHERE (ID IS NOT NULL) and DelFlag <> 1 and StaffId = '" + hidID.Value + "'";
        ...
        protected void rptList_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("BD_StaffEvalInfoUpdate.aspx?id=" + Func.ParseString(e.CommandArgument));
            }
            ShowData();
        }
    }
