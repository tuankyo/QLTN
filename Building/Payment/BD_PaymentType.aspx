                                ...
                                <table width="100%" cellspacing="0" cellpadding="0" class="tablelist" border="1"
                                    ...
                                    <tr>
                                        <td align="left" width="40%">
                                            ...
                                            <asp:DropDownList ID="drpPaymentType" Width="100%" runat="server" AutoPostBack="true"
                                                OnSelectedIndexChanged="drpPaymentType_OnSelectedIndexChanged" />
                                        </td>
                                        <td align="left" width="40%">
                                        ...
                                        <td>
                                            <asp:Button CssClass="btn_blue" ID="Button7" runat="server" Text="Thiết lập" OnClick="btnSetting_Click"
                                    ...
                                    <tr>
                                        <td colspan="3">
                                            ...
                                            </br> <font color="red">Lưu ý: Có 2 Danh mục cấp 1 (DOANH THU và THU CHI)<br />
                                                Hệ thống cho phép lưu tối đa 4 cấp Danh Mục </font>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="3">
                                            <asp:ListBox ID="lstPaymentType" Width="100%" runat="server" Rows="50" Height="300px"
                                                SelectionMode="Multiple" AutoPostBack="true" OnSelectedIndexChanged="lstPaymentType_OnSelectedIndexChanged">
                                            </asp:ListBox>
                                        </td>
                                    </tr>
                                </table>
