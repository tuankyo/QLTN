...
{
    public partial class AdminBuildingList : PageBase
    {
        ...
        private string editPageName = "AdminBuildingEdit";
        ...
        private void ShowData()
        {
            ...
            try
            {
                ...
                sql += " WHERE (BuildingId IS NOT NULL) and DelFlag <> 1 ";
                ...
                sql += " FROM Mst_Building ";
                sql += " WHERE BuildingId IS NOT NULL and DelFlag=0 ";
